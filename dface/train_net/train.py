...
def train_onet(model_store_path, end_epoch,imdb,
    ...
    # Using Tucker-2 to compress the layers
    net.conv2 = TkdVbmf.Tkd2ConvVbmf(net.conv2, cacb1=1, sigma2_1 = None, cacb2=1, sigma2_2 = None)
    net.conv3 = TkdVbmf.Tkd2ConvVbmf(net.conv3, cacb1=1, sigma2_1 = None, cacb2=1, sigma2_2 = None)
    net.conv4 = TkdVbmf.Tkd2ConvVbmf(net.conv4, cacb1=1, sigma2_1 = None, cacb2=1, sigma2_2 = None)
